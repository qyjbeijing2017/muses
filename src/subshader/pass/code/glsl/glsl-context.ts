        ...
        this._types = {
            ...
            'vec3': {
                ...
                rules: [
                    ...
                    { test: /^vec3\(vec2(,float){0,1}\)$/, returnType: 'vec3' },
                    { test: /^vec3\(float,vec2\)$/, returnType: 'vec3' },
            ...
            'vec4': {
                ...
                rules: [
                    ...
                    { test: /^vec4\(vec2(,float){0,2}\)$/, returnType: 'vec4' },
                    { test: /^vec4\(vec3(,float){0,1}\)$/, returnType: 'vec4' },
                    { test: /^vec4\(float,vec3\)$/, returnType: 'vec4' },
                    { test: /^vec4\(float,vec2(,float){0,1}\)$/, returnType: 'vec4' },
                    { test: /^vec4\(vec2,vec2\)$/, returnType: 'vec4' },
